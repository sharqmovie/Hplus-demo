...
// 1) AdminDoctors render ulanmagan bo'lsa, To'lovlar renderidan oldin qo'shamiz
if (!code.includes('adminTab === "doctors"')) {
  ...
  if (!code.includes(paymentsRender)) {
    throw new Error("Payments render qatori topilmadi. AdminMain render blokini tekshirish kerak.");
  }
  ...
  console.log("OK: AdminDoctors render qo'shildi.");
} else {
  console.log("AdminDoctors render oldin bor.");
}
...
console.log("Tayyor: Shifokorlar sahifasi to'g'rilandi.");